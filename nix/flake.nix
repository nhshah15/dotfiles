{
  description = "Neil Shah's nix-darwin system flake";
  ...
  outputs =
    ...
    let
      configuration =
        { pkgs, ... }:
        {
          # Set system's primary user.
          system.primaryUser = "neilshah";

          # MacOS system-wide settings.
          ...
          # Apps in Mac App Store via Homebrew.
          homebrew.masApps = {
